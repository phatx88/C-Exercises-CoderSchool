...
//// Print the average
//Console.WriteLine("The average of {0} and {1} is: {2}", num1, num2, average);
...
//// Print the result
//Console.WriteLine("The area of the rectangle with length {0} and width {1} is: {2}", length, width, area);
...
//// Test data
//double radius = 5;
//double pi = Math.PI; // Get the value of Pi from the Math class

//// Calculate the volume
//double volume = (4.0 / 3.0) * pi * Math.Pow(radius, 3);

//// Print the result
//Console.WriteLine("The volume of the sphere with radius {0} is: {1}", radius, volume);
...
//double rate = 0.05;
//int time = 5;
//int n = 1; // assuming interest is compounded annually
...
//// print the result
//Console.WriteLine("the compound interest after {0} years on an investment of ${1} at an interest rate of {2}% is: ${3}", time, principal, rate * 100, interest);
...
//    Console.WriteLine("The roots of the quadratic equation are: {0} and {1}", root1, root2);
//}
//else if (discriminant == 0)
//{
//    // One real root (repeated)
//    double root = -b / (2 * a);
//    Console.WriteLine("The root of the quadratic equation is: {0}", root);
//}
//else
//{
...
//// Print the result
//Console.WriteLine("The {0}th term of the arithmetic sequence is: {1}", termNumber, nthTerm);
...
//if (number <= 100)
//{
//    Console.WriteLine("{0} is less than or equal to 100", number);
//}
//else
//{
//    Console.WriteLine("{0} is greater than 100", number);
//}
...
//{
//    Console.WriteLine("{0} is even and greater than 10", number);
//}
//else
//{
//    Console.WriteLine("{0} does not satisfy both conditions", number);
//}
...
//{
//    Console.WriteLine("{0} is divisible by either 3 or 5", number);
//}
//else
//{
//    Console.WriteLine("{0} is not divisible by either 3 or 5", number);
//}
...
//// Increment the number by 5 using shorthand assignment operator
//number += 5;

//// Print the incremented number
//Console.WriteLine("The number after incrementing by 5 is: {0}", number);
...
//// Calculate the remainder when dividing 'number' by 7 and update 'number'
//number %= 7;

//// Print the updated value of 'number'
//Console.WriteLine("The remainder when dividing 27 by 7 is: {0}", number);
